...
export default function Intro() {
  ...
  return (
    <section className="bg-black py-20 px-6" id="intro">
      ...
      <div className="flex items-center flex-col sm:flex-row gap-4 justify-center mb-16 ">
        <button className="bg-blue-600 hove:blue-700 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/50 cursor-pointer" onClick={() => navigate('/produto/iphone17')}>
          Comprar agora
        </button>
        <button className="bg-transparent border-2 border-white hover:bg-white hover:text-black text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 shadow-md shadow-white/50 cursor-pointer">
          Saiba mais
        </button>
      </div>
